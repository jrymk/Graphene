...
namespace gfn::serializable {
    ...
    void Uuid::getValueStr(gfn::Command& output) const {
        output.newParam("-value", value);
    }

    void Uuid::setValueStr(const std::string& _value, gfn::Command& output) {
        if (isUuid(value)) {
            value = _value;
    ...
    void Bool::getValueStr(gfn::Command& output) const {
        output.newParam("-value", (value ? "true" : "false"));
    }

    void Bool::setValueStr(const std::string& _value, gfn::Command& output) {
        if (_value == "true")
            value = true;
    ...
    void Int::getValueStr(gfn::Command& output) const {
        output.newParam("-value", std::to_string(value));
    }

    void Int::setValueStr(const std::string& _value, gfn::Command& output) {
        int x;
    ...
    void Double::getValueStr(gfn::Command& output) const {
        output.newParam("-value", std::to_string(value));
    }

    void Double::setValueStr(const std::string& _value, gfn::Command& output) {
        double x;
    ...
    void Vec2f::getValueStr(gfn::Command& output) const {
        output.newParam("-value", "(" + std::to_string(value.x) + "," + std::to_string(value.y) + ")");
    }

    void Vec2f::setValueStr(const std::string& _value, gfn::Command& output) {
        double x, y;
    ...
    void Color::getValueStr(gfn::Command& output) const {
    ...
    void Color::setValueStr(const std::string& _value, gfn::Command& output) {
        float x, y, z, w;
        uint32_t u32;
