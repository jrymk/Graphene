...
void Graph::addVertex(gfn::Command command, gfn::Command& output) {
    pendingUpdate = true;
...
void Graph::removeVertex(gfn::Command command, gfn::Command& output) {
    pendingUpdate = true;
    gfn::Uuid uuid;
...
void Graph::addEdge(gfn::Command command, gfn::Command& output) {
    pendingUpdate = true;
...
void Graph::removeEdge(gfn::Command command, gfn::Command& output) {
    pendingUpdate = true;
