...
/// @brief Stores all the properties such as positions, colors and force values for internal use
    ...
    public:
        ...
        void setVertexProp(gfn::Command command, gfn::Command& output);

        void getVertexProp(gfn::Command command, gfn::Command& output);

        void setEdgeProp(gfn::Command command, gfn::Command& output);

        void getEdgeProp(gfn::Command command, gfn::Command& output);
    };
