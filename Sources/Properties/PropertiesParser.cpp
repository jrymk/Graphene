...
namespace gfn {
    void Properties::setVertexProp(gfn::Command command, gfn::Command &output) {
        gfn::Uuid uuid;
        gfn::VertexProps* p;
    ...
    void Properties::getVertexProp(gfn::Command command, gfn::Command &output) {
        gfn::Uuid uuid;
        gfn::VertexProps* p;
        if (!command.getParamValue("-uuid").empty()) {
            // uuid provided
    ...
    void Properties::setEdgeProp(gfn::Command command, gfn::Command &output) {
        gfn::Uuid uuid;
        gfn::EdgeProps* p;
        if (!command.getParamValue("-uuid").empty()) {
            // uuid provided
    ...
    void Properties::getEdgeProp(gfn::Command command, gfn::Command &output) {
        gfn::Uuid uuid;
        gfn::EdgeProps* p;
        if (!command.getParamValue("-uuid").empty()) {
            // uuid provided
