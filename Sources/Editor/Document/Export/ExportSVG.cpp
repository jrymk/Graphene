...
namespace gfn {
    void Document::exportSVG() {
        ImGui::SetCursorPosY(ImGui::GetWindowHeight() - 64.0f);

        if (gfn::button("\ue161 Save SVG", HUE_BLUE_CONTRAST, HUE_CONTRAST, false, ImGui::GetContentRegionAvailWidth(), 0, false)) {
            svg::Document svg("svgexport.svg",
