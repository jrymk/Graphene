                ...
                if (vertexProps.empty())
                    ...
                    // label
                    {
                        ...
                        if (vertexProps.size() == 1) {
                            ...
                            if (ImGui::InputTextMultiline("", widget, 1024, ImVec2(ImGui::GetContentRegionAvailWidth(), 50.0f), 0) ||
                                ImGui::IsItemEdited()) {
                    ...
                    // label size
                    {
                        ...
                        ImGui::PushItemWidth(ImGui::GetContentRegionAvailWidth());
                        static float widget;
                        ImGui::DragFloat("##labelSize", (float*) &widget, 0.01, FLT_MIN, FLT_MAX, "%.6f", 0);
                        if (getDoc(activeDoc)->graphview.selection.onChangeSelection) {
                    ...
                    // label color
                    {
                        ...
                        if (ImGui::ColorButton("##labelColorSET", widget, ImGuiColorEditFlags_AlphaPreview))
                            ImGui::OpenPopup("##labelColorPopupSET");
                        /*ImGui::GetWindowDrawList()->AddText(ImVec2(ImGui::GetCursorScreenPos().x + 2.0f, ImGui::GetCursorScreenPos().y - 25.0f),
                                                            ...
                                                            "\ue145", nullptr);*/
                        if (ImGui::BeginPopup("##labelColorPopupSET")) {
                            ImGui::PushItemWidth(200.0f);
                            ImGui::ColorButton("##labelColor2", widget, ImGuiColorEditFlags_AlphaPreview, ImVec2(200.0f, 30.0f));
                        ...
                        float btnSize = 29.0f;
                        /// SELECTION PALATTE
                        if (ImGui::TreeNode("Selection##labelColor")) {
                            /*ImGui::PushDisabled(true);
                            ...
                            for (auto& c : hsvV) {
                                ...
                                if (ImGui::ColorButton(("##labelColor" + std::to_string(count)).c_str(), rgba,
                                                       ImGuiColorEditFlags_AlphaPreview)) {
                                    widget = rgba;
                                    edit = true;
                                }
                        ...
                        if (ImGui::TreeNode("Recents")) {
                            if (!history.empty()) {
                                ...
                                for (auto& c : history) {
                                    if (ImGui::ColorButton(("##labelColorHistory" + std::to_string(count)).c_str(),
