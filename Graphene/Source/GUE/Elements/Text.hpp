...
namespace gue {
	...
	public:
		TextElement(const std::string& debugName) : Element(debugName) {
			this->x = { 0.0, 0.0 };
			this->y = { 0.0, 0.0 };
			this->w = { 0.0, 1.0 };
			this->h = { 0.0, 1.0 };
		...
		TextElement(const std::string& debugName, AVec x, AVec y, AVec w, AVec h, Color fillColor) : Element(debugName) {
			this->x = x;
			this->y = y;
			this->w = h;
			this->h = w;
